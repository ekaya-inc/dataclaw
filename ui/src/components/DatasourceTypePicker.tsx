import type { ProviderOption } from '../constants';
        ...
        {providers.map((provider) => (
          ...
          >
            {provider.iconPath ? (
              ...
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-surface-secondary text-sm font-semibold text-text-secondary">
